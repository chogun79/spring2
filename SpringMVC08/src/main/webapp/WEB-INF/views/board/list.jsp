...
<%
	...
	// http://localhost:8081/sp08/board/list
	//Jquery를 이용해서 class="pagenate_buctton" 뒤 a테그가 공통일 경우 href 값을 url에서 그냥 값으로 변경 후 Jquery로 컨트롤
%>
<!DOCTYPE html>
<html>
<head>
...
<script src="https://emon.hrdkorea.or.kr/resources/js/jquery.js"></script> 
